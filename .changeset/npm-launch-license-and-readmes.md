---
"@supa-media/chat": patch
"@supa-media/claude": patch
"@supa-media/convex": patch
"@supa-media/core": patch
"@supa-media/dev": patch
"@supa-media/dev-assistant": patch
"@supa-media/linter": patch
"@supa-media/metro": patch
"@supa-media/native-safety": patch
"@supa-media/notifications": patch
"@supa-media/payments": patch
"@supa-media/scripts": patch
"@supa-media/testing": patch
---

Every package now ships an MIT LICENSE file and a README inside its tarball.
